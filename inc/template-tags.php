...
function emallshop_entry_meta() {
	...
	if ( current_theme_supports( 'post-formats', $format ) && in_array('post-format', emallshop_get_option('show-specific-postmeta', array('post-format','post-author','cat-links','tags-links','comments-link')))) {
	...
	if ( 'post' == get_post_type() ) {
		if ( (is_singular() || is_multi_author()) && in_array('post-author', emallshop_get_option('show-specific-postmeta', array('post-format','post-author','cat-links','tags-links','comments-link')))) {
		...
		if ( $categories_list && emallshop_categorized_blog() && in_array('cat-links', emallshop_get_option('show-specific-postmeta', array('post-format','post-author','cat-links','tags-links','comments-link')))) {
		...
		if ( $tags_list && in_array('tags-links', emallshop_get_option('show-specific-postmeta', array('post-format','post-author','cat-links','tags-links','comments-link')))) {
...
function emallshop_image_overlay(){
	...
	<div class="image-overlay">
		<div class="entry-action">
			<a href="<?php echo esc_url($image_link);?>" class="fancybox"><i class="fa  fa-search"></i></a>
